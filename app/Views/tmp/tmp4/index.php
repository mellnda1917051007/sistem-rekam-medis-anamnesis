...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=<?php echo Setting::instance()->charset(); ?>">
    <meta name="Author" content='<?php echo Setting::instance()->author(); ?>' />
    <meta name="description" content="<?php echo Setting::instance()->description(); ?>" />
    <meta name="keywords" content="<?php echo Setting::instance()->keywords(); ?>" />
        ...
        <div class="navbar-container ace-save-state" id="navbar-container">
            <button type="button" class="navbar-toggle menu-toggler pull-left" id="menu-toggler" data-target="#sidebar">
                <span class="sr-only">
                    ...
                    <?php echo Setting::instance()->judul(); ?></span>
            ...
            <div class="navbar-header pull-left">
                <a href="index.html" class="navbar-brand">
                    <small>
                        ...
                        <?php echo strtolower(Setting::instance()->judul()); ?>
                    </small>
                </a>
            </div>
            ...
            <div class="navbar-buttons navbar-header pull-right" role="navigation">
                <ul class="nav ace-nav">
					...
					">
                            <img class="nav-user-photo" src="<?php echo Setting::instance()->avatar(); ?>" alt="Jason's Photo" />
...
-->
            <ul class="nav nav-list">
                ...
                <!-- MENU -->
                <?php
                $m = new SimpleXMLElement('../../../include/settings/menu.xml', 0, true);
                foreach ($m as $i) {
                    if ($i->t == 's') {
                ?>
                        <!-- SINGLE -->
                        ...
                        <li class="">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="">
                                    <b class="arrow"></b>
                                    <?php
                                    $m1 = new SimpleXMLElement('../../../include/settings/menu.xml', 0, true);
                                    foreach ($m1 as $i1) {
