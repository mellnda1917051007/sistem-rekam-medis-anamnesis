...
$url = Setting_Keluarga::instance()->get_lokasi_tmp();

function home()
{
    return base_url("keluarga/home");
}

function logout()
{
    return base_url("keluarga/logout");
}
                            ...
                            <aside class="sidebar">
                                <nav class="sidebar-nav">
                                    <ul class="metismenu" id="menu">
                                        <!-- MENU -->
                                        <?php
                                        $m = Setting_Keluarga::instance()->file_menu_xml();
                                        foreach ($m as $i) {
                                            if ($i->t == 's') {
                                        ?>
                                                <!-- SINGLE -->
                                                <li class="treeview">
                                                    <a href="<?php echo Bridge_keluarga::link($i->l); ?>">
                                            ...
                                            ?>
                                                ...
                                                <li class="treeview">
                                                    ...
                                                    <ul class="treeview-menu">
                                                        <li>
                                                            <?php
                                                            $m1 = Setting_Keluarga::instance()->file_menu_xml();
                                                            foreach ($m1
                                                            ...
                                                            ?>
                                                        <li>
                                                            <a class="item" onclick="window.location = '<?php echo Bridge_keluarga::link($i1->l); ?>'">
                                                                <?php echo $i1->n; ?></a>
                                                        </li>
                                                <?php }
                                                            } ?>
