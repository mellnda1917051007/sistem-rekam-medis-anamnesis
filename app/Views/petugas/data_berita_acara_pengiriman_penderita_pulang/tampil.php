            ...
            <tbody>
                ...
                foreach ($data_berita_acara_pengiriman_penderita_pulang as $data) { ?>
                    <tr class="event2">
                        ...
                        <td align="center"><a href="<?php echo base_url("uploads/$data[file]"); ?>">File Berita Acara Penderita Pulang</a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    function hapus_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `data_berita_acara_pengiriman_penderita_pulang/hapus/${id}`;
            }
        })
    }
</script>
