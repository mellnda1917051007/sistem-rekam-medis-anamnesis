    ...
    <div style="overflow-x:auto;">
        <table <?php tabel(100, '%', 1, 'left'); ?>>
            <tr>
                ...
                <th align="center" class="th_border cell">Nama Tenaga Medis</th>
                <th align="center" class="th_border cell">Status</th>
                <th align="center" class="th_border cell">Riwayat Rekam Medis</th>
            </tr>
            ...
            <tbody>
                ...
                foreach ($data_rekam_medis as $data) { ?>
                    <tr class="event2">
                        ...
                        <td align="center">
                            <a href="data_anamnesis">Riwayat Anamnesis</a><br>
                            <a href="data_berita_acara">Riwayat Berita Acara</a><br>
                            <a href="data_berita_acara_pengiriman_penderita_pulang">Riwayat Berita Acara Penderita Pulang</a><br>
                            <a href="data_pembayaran">Riwayat Pembayaran</a>
