...
<body>
    ...
    <?php /*
    <a target="blank" href="cetak.php?berdasarkan=data_berita_acara&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_export('Export Excel'); ?>
    </a>

    <a target="blank" href="cetak.php?berdasarkan=data_berita_acara&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode; ?>">
        <?php btn_cetak('Cetak'); ?>
    </a>
     */
    ?>
                    ...
                    <tr class="event2">
                        <td class="th_border cell" align="center" width="200">
                            <table border="0">
                                <tr>
                                    <td>
                                        <a href="<?php index(); ?>/detail?proses=<?= encrypt($data['id_berita_acara']); ?>">
                                            <?php btn_detail('Detail'); ?></a>
                                    </td>
                                    <td>
                                        <a href="<?php index(); ?>/edit?proses=<?= encrypt($data['id_berita_acara']); ?>">
                                            <?php //btn_edit('Edit'); 
                                            ?></a>
                                    </td>
                                    <td>
                                        <a onclick="hapus_data('<?= encrypt($data['id_berita_acara']); ?>')">
                                            <!-- <?php //btn_hapus('Hapus'); 
                                                    ?></a> -->
                                    </td>
                                </tr>
                        ...
                        <td align="center"><a href="<?php echo base_url("uploads/$data[file]"); ?>">File Berita Acara</a></td>
                        <td align="center">
    ...
    function hapus_data(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `data_berita_acara/hapus/${id}`;
            }
        })
    }
</script>
