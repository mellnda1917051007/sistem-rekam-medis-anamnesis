...
use App\Models\DataBeritaAcaraPengirimanPenderitaPulang as ModelsDataBeritaAcaraPengirimanPenderitaPulang;

class DataBeritaAcaraPengirimanPenderitaPulangRepo
{
    private static $model = ModelsDataBeritaAcaraPengirimanPenderitaPulang::class;

    /**
     * @param $berdasarkan
     * @param $isi
     * @return ModelsDataBeritaAcaraPengirimanPenderitaPulang
     */
    ...
    {
        $db = db_connect();
        return $db->query("desc data_berita_acara_pengiriman_penderita_pulang")->getResultArray();
    }
    ...
    {
        $model = new self::$model();
        $model->where("id_berita_acara_penderita_pulang", $proses);
        return $model->first();
    }
