...
use App\Repo\petugas\DataAnamnesisRepo;
...
class DataAnamnesis extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("petugas/data_anamnesis/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("petugas.data_anamnesis"));
            }
        }
        return view("petugas/data_anamnesis/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("petugas/data_anamnesis/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("petugas/data_anamnesis/cetak", $this->data);
    }
    ...
    private function validate_edit()
    {
        $rule = [
			...
			,'keadaan_baik' => 'required'
			,'kesadaran' => 'required'
			,'refleksi_pupil_kanan' => 'required'
			,'refleksi_pupil_kiri' => 'required'
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataAnamnesisRepo::detail($proses);
        return view("petugas/data_anamnesis/detail", $this->data);
    }
