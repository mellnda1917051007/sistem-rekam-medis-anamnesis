...
use App\Repo\petugas\DataRekamMedisRepo;
...
class DataRekamMedis extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("petugas/data_rekam_medis/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("petugas.data_rekam_medis"));
            }
        }
        return view("petugas/data_rekam_medis/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("petugas/data_rekam_medis/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("petugas/data_rekam_medis/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataRekamMedisRepo::detail($proses);
        return view("petugas/data_rekam_medis/detail", $this->data);
    }
