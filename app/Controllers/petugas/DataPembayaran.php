...
use App\Repo\petugas\DataPembayaranRepo;
...
class DataPembayaran extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("petugas/data_pembayaran/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("petugas.data_pembayaran"));
            }
        }
        return view("petugas/data_pembayaran/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("petugas/data_pembayaran/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("petugas/data_pembayaran/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataPembayaranRepo::detail($proses);
        return view("petugas/data_pembayaran/detail", $this->data);
    }
