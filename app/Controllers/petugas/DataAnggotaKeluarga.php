...
use App\Repo\petugas\DataAnggotaKeluargaRepo;
...
class DataAnggotaKeluarga extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("petugas/data_anggota_keluarga/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("petugas.data_anggota_keluarga"));
            }
        }
        return view("petugas/data_anggota_keluarga/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("petugas/data_anggota_keluarga/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("petugas/data_anggota_keluarga/cetak", $this->data);
    }

    private function validate_edit()
    {
        $rule = [
            'id_anggota_keluarga' => 'required'
			,'id_pasien' => 'required'
			,'nama' => 'required'
			,'alamat' => 'required'
			,'no_telepon' => 'required'
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataAnggotaKeluargaRepo::detail($proses);
        return view("petugas/data_anggota_keluarga/detail", $this->data);
    }
