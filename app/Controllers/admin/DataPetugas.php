...
use App\Repo\admin\DataPetugasRepo;
...
class DataPetugas extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("admin/data_petugas/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(base_url(route_to("admin.data_petugas")));
            }
        }
        return view("admin/data_petugas/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_edit())) {
                ...
                return $this->response->redirect(route_to("admin.data_petugas"));
            }
        }
        $this->data["data"] = DataPetugasRepo::detail($proses);
        return view("admin/data_petugas/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("admin/data_petugas/cetak", $this->data);
    }

    private function validate_edit()
    {
        $rule = [
            'id_petugas' => 'required', 'nama' => 'required', 'jenis_kelamin' => 'required', 'alamat' => 'required', 'no_telepon' => 'required', 'username' => 'required', 'password' => 'required'
        ];
        return $rule;
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataPetugasRepo::detail($proses);
        return view("admin/data_petugas/detail", $this->data);
    }
