...
use App\Repo\admin\DataPasienRepo;
...
class DataPasien extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("admin/data_pasien/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(base_url(route_to("admin.data_pasien")));
            }
        }
        return view("admin/data_pasien/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_edit())) {
                ...
                return $this->response->redirect(route_to("admin.data_pasien"));
            }
        }
        $this->data["data"] = DataPasienRepo::detail($proses);
        return view("admin/data_pasien/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("admin/data_pasien/cetak", $this->data);
    }

    private function validate_edit()
    {
        $rule = [
            'id_pasien' => 'required', 'id_petugas' => 'required', 'nama_lengkap' => 'required', 'jenis_kelamin' => 'required', 'tanggal_masuk' => 'required', 'diagnosa_kejiwaan' => 'required', 'status' => 'required'
        ];
        return $rule;
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataPasienRepo::detail($proses);
        return view("admin/data_pasien/detail", $this->data);
    }
