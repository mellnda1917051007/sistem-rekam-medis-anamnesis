...
use App\Repo\keluarga\DataPetugasRepo;
...
class DataPetugas extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("keluarga/data_petugas/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("keluarga.data_petugas"));
            }
        }
        return view("keluarga/data_petugas/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("keluarga/data_petugas/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("keluarga/data_petugas/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataPetugasRepo::detail($proses);
        return view("keluarga/data_petugas/detail", $this->data);
    }
