...
use App\Repo\keluarga\DataPasienRepo;
...
class DataPasien extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("keluarga/data_pasien/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("keluarga.data_pasien"));
            }
        }
        return view("keluarga/data_pasien/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("keluarga/data_pasien/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("keluarga/data_pasien/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataPasienRepo::detail($proses);
        return view("keluarga/data_pasien/detail", $this->data);
    }
