...
use App\Repo\keluarga\DataAdminRepo;
...
class DataAdmin extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("keluarga/data_admin/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("keluarga.data_admin"));
            }
        }
        return view("keluarga/data_admin/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("keluarga/data_admin/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("keluarga/data_admin/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataAdminRepo::detail($proses);
        return view("keluarga/data_admin/detail", $this->data);
    }
