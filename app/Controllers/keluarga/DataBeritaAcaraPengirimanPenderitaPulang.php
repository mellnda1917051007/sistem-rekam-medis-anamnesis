...
use App\Repo\keluarga\DataBeritaAcaraPengirimanPenderitaPulangRepo;
...
class DataBeritaAcaraPengirimanPenderitaPulang extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($berdasarkan && $isi) {
            ...
            $data_berita_acara_pengiriman_penderita_pulang = DataBeritaAcaraPengirimanPenderitaPulangRepo::tampil()->where('id_rekam_medis', $id_rekam_medis)
        ...
        return view("keluarga/data_berita_acara_pengiriman_penderita_pulang/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("keluarga.data_berita_acara_pengiriman_penderita_pulang"));
            }
        }
        return view("keluarga/data_berita_acara_pengiriman_penderita_pulang/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("keluarga/data_berita_acara_pengiriman_penderita_pulang/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("keluarga/data_berita_acara_pengiriman_penderita_pulang/cetak", $this->data);
    }

    private function validate_edit()
    {
        $rule = [
            'id_berita_acara_penderita_pulang' => 'required', 'id_rekam_medis' => 'required', 'file' => 'permit_empty|uploaded[file]|mime_in[file,image/jpg,image/jpeg,image/gif,image/png]|max_size[file,2048]'
        ];
        return $rule;
    }
    ...
    {
        $rule = [
            'id_berita_acara_penderita_pulang' => 'required', 'id_rekam_medis' => 'required', 'file' => 'uploaded[file]|mime_in[file,image/jpg,image/jpeg,image/gif,image/png]|max_size[file,2048]'
        ];
        return $rule;
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataBeritaAcaraPengirimanPenderitaPulangRepo::detail($proses);
        return view("keluarga/data_berita_acara_pengiriman_penderita_pulang/detail", $this->data);
    }
