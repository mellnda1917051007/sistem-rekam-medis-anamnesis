...
class DataAnggotaKeluarga extends BaseController
{
    ...
    public function index()
    {
        ...
        return view("keluarga/data_anggota_keluarga/tampil", $this->data);
    }
    ...
    public function tambah()
    {
        if ($this->request->getPost()) {
            if (!$this->validate($this->validate_simpan())) {
                ...
                return $this->response->redirect(route_to("keluarga.data_anggota_keluarga"));
            }
        }
        return view("keluarga/data_anggota_keluarga/tambah", $this->data);
    }
    ...
    public function edit()
    {
        ...
        return view("keluarga/data_anggota_keluarga/edit", $this->data);
    }
    ...
    public function cetak()
    {
        ...
        return view("keluarga/data_anggota_keluarga/cetak", $this->data);
    }
    ...
    public function detail()
    {
        $proses = $this->request->getPostGet("proses");
        $this->data['data'] = DataAnggotaKeluargaRepo::detail($proses);
        return view("keluarga/data_anggota_keluarga/detail", $this->data);
    }
