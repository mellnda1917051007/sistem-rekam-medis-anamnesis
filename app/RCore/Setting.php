...
$file = dirname(__FILE__) . "/settings.xml";
...
class Setting
{
    ...
    {
        $file = dirname(__FILE__) . "/menu.xml";
        return new \SimpleXMLElement($file, 0, true);
    }

    public function get_lokasi_lg()
    {
        return base_url("") . "/data/tmp/" . Setting::instance()->lg . "/file";
    }

    public function get_lokasi_tmp()
    {
        return base_url("") . "/data/tmp/" . Setting::instance()->tmp . "/file/";
    }
